    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li ><a  href="ajout.php" class="nav-link px-2 link-dark lin"> Product</a></li>
        </ul>
        <a style="margin-left: 10px ;" type="button" class="btn btn-dark" href="logout.php">Déconnexion</a>
      </div>
    </div>
  </header>
<?php
...
$allproduit=$bdd->query('SELECT *  FROM produits where id_produit ORDER BY id_produit DESC LIMIT 10');
if(isset($_GET['recherche']) AND !empty($_GET['recherche'])){
    $recherche= htmlspecialchars($_GET['recherche']);
    $allproduit=$bdd->query('SELECT *  FROM produits where id_produit AND nomp LIKE "%'.$recherche.'%" ORDER BY id_produit DESC LIMIT 10');
}
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form method="POST" enctype="multipart/form-data">
      <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Nom de Produits</label>
          ...
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Description Détaillée</label>
        ...
        <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3"></textarea>
         ...
         <div class="mb-3">
          <label for="formFile" class="form-label">Image Produits</label>
...
<h1 align='center' class="parti" >  Listes Produits</h1>
    <br><br><br><br>
  ...
  if($allproduit-> rowCount()>0){
    ...
    ?>
        ...
        <td>  <a class="btn btn-danger" href="ajout.php?supprime=<?= $produit['id_produit'] ?>">Supprimer</a>
        <a class="btn btn-warning" href="modifierProduit.php?id_produit=<?= $produit['id_produit'] ?>">Modifier</a> </td>
