    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li ><a  href="commande.php" class="nav-link px-2 link-dark lin"> Commandes</a></li>
        </ul>
...
<h1 align='center' class="parti" > Listes Commandes</h1>
    <br><br><br><br>
   ...
   if(isset($_GET['confirme'])AND !empty($_GET['confirme'])){
    ...
    $req=$bdd->prepare('UPDATE commandes SET confirmer = 1 WHERE id_com= ?');
  ...
  if($allCommandes-> rowCount()>0){
    ...
    <tr>
        ...
        <td>  <?php if($commandes['confirmer']==0){?> <a class="btn btn-success" href="commande.php?confirme=<?= $commandes['id_com'] ?>">Confirmer</a><?php }?>
            <a class="btn btn-danger" href="commande.php?supprime=<?= $commandes['id_com'] ?>">Supprimer</a></td>
